...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject is the factor that will occur based on operation performed
    # if inject is 2 then the result for above would be 48 
  end
  ...
  # we perform operation only if that file is exists if it would not then ruby will raise exception
