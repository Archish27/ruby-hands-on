...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # __send__ is metaprogramming naming convention. Some classes may have send methods like socket,
    # it may conflict with that methods so ruby provides __send__. If this gets override warning is thrown by ruby.
  end
