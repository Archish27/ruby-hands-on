...
class AboutHashes < Neo::Koan
  ...
  def test_changing_hashes
    ...
    # If it was not broken into literal ruby would think as "block of code" since it is embedded into block
    # Now when it is assigned to variable ruby interpreter knows that it is "hash"
  end
